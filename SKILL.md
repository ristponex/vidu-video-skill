---
name: vidu-video
description: Generate AI videos using Vidu Q3 models via Atlas Cloud API. Supports anime style, start-end frame control, audio generation, reference-to-video. Use when user asks to "generate an anime video" or "create a Vidu video".
---
# Vidu Video Skill
